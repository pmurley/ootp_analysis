...
class HumanManagerHistoryEntry:
    def __init__(self, human_manager_id, team_id, year, league_id, sub_league_id, division_id, best_hitter_id, best_pitcher_id, best_rookie_id, manager_id, made_playoffs, won_playoffs, fired, position_in_division):
...
def parse(path):
    ...
    for index, row in df.iterrows():
        obj = HumanManagerHistoryEntry(*row)
        data.append(obj)
